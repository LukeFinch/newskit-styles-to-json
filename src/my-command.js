...
export default function() {
  ...
  */
  ...
  o.fontName = {family: inp.fontFamily, style: fontStyle}
  ...
  */
  ...
  e = {}
  e.type = "DROP_SHADOW"
  e.color = {r:shadow.color().red(),g:shadow.color().green(),b:shadow.color().blue(),a:shadow.color().alpha()}
  e.offset = {x:shadow.offsetX ,y:shadow.offsetY}
